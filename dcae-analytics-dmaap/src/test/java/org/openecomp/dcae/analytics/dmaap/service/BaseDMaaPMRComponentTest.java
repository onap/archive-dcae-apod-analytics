...
package org.openecomp.dcae.analytics.dmaap.service;
...
import org.openecomp.dcae.analytics.dmaap.BaseAnalyticsDMaaPUnitTest;
...
import org.openecomp.dcae.analytics.dmaap.service.publisher.DMaaPMRPublisherQueue;
...
public class BaseDMaaPMRComponentTest extends BaseAnalyticsDMaaPUnitTest {
    ...
    //region Get Authorization Header Tests
    @Test
    public void testGetAuthHeaderWithGoodValues() {
        ...
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader("m00502@tca.af.dcae.com", "Te5021abc");
    ...
    public void testGetAuthHeaderWithUserNullValue() {
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader("m00502@tca.af.dcae.com", null);
        assertFalse(" Authentication Header has value ", actualOutput.isPresent());
    }

    @Test
    public void testGetAuthHeaderWithPasswordNullValue() {
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader(null, "Te5021abc");
        assertFalse(" Authentication Header has value ", actualOutput.isPresent());
    }

    /* @Test
    public void testGetAuthHeaderWithEmptyValues() {
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader("", "");
        assertFalse(" Authentication Header has value ", actualOutput.isPresent());
    }

    @Test
    public void testGetAuthHeaderWithUserEmptyValue() {
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader("m00502@tca.af.dcae.com", "");
        assertFalse(" Authentication Header has value ", actualOutput.isPresent());
    }

    @Test
    public void testGetAuthHeaderWithPasswordEmptyValue() {
        Optional<String> actualOutput = BaseDMaaPMRComponent.getAuthHeader("", "Te5021abc");
        assertFalse(" Authentication Header has value ", actualOutput.isPresent());
    }*/
    //endregion

    //region Publisher URI Tests
    @Test
    ...
    public void testCreatePublishURIWithURISyntaxException() {
        ...
        URI actualURI = BaseDMaaPMRComponent.createPublisherURI(badPublisherConfig);
    }

    //endregion

    //region Subscriber URI Tests
    @Test
    ...
    //region Convert toJSON String tests
    @Test
    ...
    //region Convert JSONtoString String tests
    ...
    //region Test add message to recovery queue
    @Test
    ...
    //region createSubscriberResponse tests
    @Test
