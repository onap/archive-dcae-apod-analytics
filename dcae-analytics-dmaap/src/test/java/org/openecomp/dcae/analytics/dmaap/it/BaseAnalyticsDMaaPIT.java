...
package org.openecomp.dcae.analytics.dmaap.it;
...
public abstract class BaseAnalyticsDMaaPIT extends BaseDCAEAnalyticsIT {
    ...
    protected static final String USERNAME = "m00502@tca.af.dcae.com";
    protected static final String PASSWORD = "Te5021abc";
     ...
     *
     * @param dMaaPMRPublisher
     * @return
     */
    protected static DMaaPMRPublisherResponse publishTwoSampleMessages(DMaaPMRPublisher dMaaPMRPublisher) {
        DMaaPMRPublisherResponse dMaaPMRPublisherResponse = dMaaPMRPublisher.publish(getTwoSampleMessage());
        return dMaaPMRPublisherResponse;
    }
