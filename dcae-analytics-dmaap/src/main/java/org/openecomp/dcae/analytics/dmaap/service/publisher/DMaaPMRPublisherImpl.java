...
package org.openecomp.dcae.analytics.dmaap.service.publisher;
...
import org.openecomp.dcae.analytics.dmaap.service.BaseDMaaPMRComponent;
...
import static org.openecomp.dcae.analytics.common.utils.HTTPUtils.isSuccessfulResponseCode;
    ...
    public DMaaPMRPublisherResponse publish(List<String> messages) throws DCAEAnalyticsRuntimeException {
        ...
        if (batchQueueRemainingSize > messages.size()) {
            ...
            LOG.debug("Batch Queue capacity exceeds messages size. Flushing of all pending messages to DMaaP MR " +
                    "Publisher Topic.");
            final DMaaPMRPublisherResponse forcePublishResponse =
                    forcePublish(Lists.newLinkedList(Iterables.concat(queueMessages, messages)));
            return forcePublishResponse;
        }
