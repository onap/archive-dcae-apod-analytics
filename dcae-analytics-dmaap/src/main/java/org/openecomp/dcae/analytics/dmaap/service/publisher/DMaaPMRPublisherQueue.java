...
public interface DMaaPMRPublisherQueue {
     ...
     * @return current size of batch queue
     *
     * @throws IllegalStateException if batch queue does not have enough space
     */
    int addBatchMessages(List<String> batchMessages) throws IllegalStateException;
     ...
     * @return current size of the recoverable queue
     *
     * @throws IllegalStateException if recoverable queue does not have enough space
     */
    int addRecoverableMessages(List<String> recoverableMessages) throws IllegalStateException;
