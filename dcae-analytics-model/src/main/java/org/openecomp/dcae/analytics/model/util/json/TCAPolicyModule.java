...
import org.openecomp.dcae.analytics.model.domain.policy.tca.BaseTCAPolicyModel;
...
import org.openecomp.dcae.analytics.model.util.json.mixin.policy.tca.BaseTCAPolicyModelMixin;
import org.openecomp.dcae.analytics.model.util.json.mixin.policy.tca.DirectionMixin;
import org.openecomp.dcae.analytics.model.util.json.mixin.policy.tca.MetricsPerFunctionalRoleMixin;
import org.openecomp.dcae.analytics.model.util.json.mixin.policy.tca.TCAPolicyMixin;
import org.openecomp.dcae.analytics.model.util.json.mixin.policy.tca.ThresholdMixin;
...
public class TCAPolicyModule extends SimpleModule {
    ...
    private static final long serialVersionUID = -5895573053812042524L;

    public TCAPolicyModule() {
        super("Threshold Crossing Alert Policy",
                new Version(1, 0, 0, null, "org.openecomp.dcae.analytics.model", "dcae-analytics-model"));
    }
