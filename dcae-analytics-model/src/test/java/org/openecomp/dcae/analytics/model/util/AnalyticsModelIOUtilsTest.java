...
package org.openecomp.dcae.analytics.model.util;


import org.junit.Test;
import org.openecomp.dcae.analytics.model.BaseAnalyticsModelUnitTest;
...
public class AnalyticsModelIOUtilsTest extends BaseAnalyticsModelUnitTest {
    ...
    public void testValidPropertiesFileLoading() throws Exception {
        final Properties properties = AnalyticsModelIOUtils.loadPropertiesFile(TEST_PROPERTIES_FILE_LOCATION);
        assertThat("Properties File must contain 2 properties", properties.size(), is(2));
    }

    @Test(expected = RuntimeException.class)
    public void testNonExistingProperitesFileLoading() throws Exception {
        AnalyticsModelIOUtils.loadPropertiesFile("InvalidPropertiesFileLocation");
    }
