...
public abstract class CDAPMetricsConstants {
     ...
     */
    public static final String TCA_SUBSCRIBER_ALL_RESPONSES_COUNT_METRIC = "tca.subscriber.fetch.all_responses";
     ...
     */
    public static final String TCA_SUBSCRIBER_UNSUCCESSFUL_RESPONSES_METRIC = "tca.subscriber.fetch.unsuccessful";

    /**
     * Metric that counts the number of successful (200 HTTP Response Code) calls to DMaaP which did not had empty
     * messages
     */
    public static final String TCA_SUBSCRIBER_RESPONSES_WITH_NO_MESSAGES_METRIC = "tca.subscriber.fetch.no_message";

    /**
     * Metric to count total number of VES Collector message processed by tca subscriber
     */
    public static final String TCA_SUBSCRIBER_TOTAL_MESSAGES_PROCESSED_METRIC = "tca.subscriber.message.count";


    /**
     * Metric to record time taken in ms by subscriber in its most recent call to fetch DMaaP MR messages
     */
    public static final String TCA_SUBSCRIBER_RESPONSE_TIME_MS_METRIC = "tca.subscriber.fetch.response_time";
